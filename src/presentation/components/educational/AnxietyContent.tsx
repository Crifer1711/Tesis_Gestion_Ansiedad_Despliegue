...
type AnxietyContentProps = {
  padded?: boolean;
};

export function AnxietyContent({ padded = true }: AnxietyContentProps) {
  const wrapperClassName = padded
    ? 'ansiedad-page-shell min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 py-16'
    : 'ansiedad-page-shell min-h-screen bg-gradient-to-b from-blue-50 to-blue-100';
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="bg-white rounded-lg p-6 border-2 border-[#71A5D9]">

...
type MentalHealthContentProps = {
  padded?: boolean;
};

export function MentalHealthContent({ padded = true }: MentalHealthContentProps) {
  const wrapperClassName = padded
    ? 'salud-mental-page-shell min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 py-16'
    : 'salud-mental-page-shell min-h-screen bg-gradient-to-b from-blue-50 to-blue-100';

  return (
    <div className={wrapperClassName}>
      <div className={padded ? 'max-w-7xl mx-auto px-6' : 'py-8'}>
        <div className={padded ? '' : 'max-w-7xl mx-auto px-6'}>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              {[
                ...
                <div key={index} className="bg-white rounded-lg border-2 border-[#71A5D9] overflow-hidden">
                  ...
                  <div className="bg-blue-50 rounded-lg p-6">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-3 py-2">
                        <div className="w-1.5 h-1.5 bg-[#71A5D9] rounded-full mt-2.5 flex-shrink-0" />
              ...
              {[
                ...
                <div key={index} className="bg-white rounded-lg border-2 border-[#71A5D9] overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="bg-blue-50 rounded-lg p-6">
                      {habito.items.map((item, itemIndex) => (
                        <div key={itemIndex} className="flex items-start gap-3 py-2">
                          <div className="w-1.5 h-1.5 bg-[#1E4D8C] rounded-full mt-2.5 flex-shrink-0" />
                          <p className="text-black text-base font-medium leading-relaxed">{item}</p>
                        </div>
                      ))}
                    </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="bg-blue-50 rounded-lg p-6 border-2 border-[#71A5D9] text-center">

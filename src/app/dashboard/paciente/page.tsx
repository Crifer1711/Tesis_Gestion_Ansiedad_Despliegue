...
import { Palette, X, Calendar, ClipboardList, Clock, CheckCircle2, ArrowUpRight, ListChecks, FileEdit } from 'lucide-react';
...
function DashboardContent() {
  ...
  return (
    <div className="flex flex-col">
      {/* Navbar en cápsula oscura */}
      <div className="sticky top-0 z-30 flex justify-center px-4 pt-3 pb-2 bg-white/85">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border-2 border-[#71A5D9] bg-white p-6 shadow-lg hover:shadow-xl transition">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-black text-[#1E4D8C]">Vie 14 Jun, 10:30</p>
                    </div>
                  </div>
                  <p className="text-sm text-slate-600">Dr. María García — Consulta de seguimiento</p>
                  <div className="mt-4 flex gap-2">
                    <span className="rounded-full bg-green-100 px-3 py-1 text-xs font-semibold text-green-700">Confirmada</span>
                    <span className="rounded-full bg-blue-100 px-3 py-1 text-xs font-semibold text-blue-700">Online</span>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border-2 border-amber-200 bg-amber-50/80 p-6 shadow-lg hover:shadow-xl transition">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-3xl font-black text-amber-800">2</p>
                    </div>
                  </div>
                ...
                <div className="rounded-2xl border-2 border-emerald-200 bg-emerald-50/80 p-6 shadow-lg hover:shadow-xl transition">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wide text-emerald-700">Aceptada</p>
                      <p className="text-3xl font-black text-emerald-800">1</p>
                    </div>
                  </div>
                  <p className="text-sm text-emerald-700">Cita agendada y confirmada</p>
                </div>
                ...
                <div className="rounded-2xl border-2 border-slate-200 bg-slate-50/80 p-6 shadow-lg hover:shadow-xl transition">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Atendida</p>
                      <p className="text-3xl font-black text-slate-700">8</p>
                    </div>
                  </div>
                  <p className="text-sm text-slate-600">Citas completadas este mes</p>
                </div>
              </div>
      ...
      {/* Botón de accesibilidad - abajo izquierda */}
          ...
          <div className="fixed inset-0 z-[60]">
            ...
            <aside className="relative h-full w-full max-w-sm overflow-y-auto border-r border-white/10 bg-slate-950/95 p-5 shadow-2xl backdrop-blur-xl">
              ...
              <p className="mb-4 text-sm text-slate-300 leading-relaxed">
                Ajusta la apariencia de la plataforma para mejorar tu experiencia visual. Puedes cambiar el color de pantalla, el tipo y tamaño de letra según tus necesidades.
              </p>
              <AccessibilityPanel />
            </aside>
          </div>

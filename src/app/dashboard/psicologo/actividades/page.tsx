...
export default async function PsychologistActividadesPage() {
  ...
  return (
    <div className="psychologist-activities-page psychologist-activities-shell space-y-6 rounded-[28px] border border-blue-100 bg-gradient-to-b from-[#f5f9ff] to-[#e7f1ff] p-4 md:p-6 shadow-sm">
      <div className="psychologist-activities-header rounded-[24px] border border-blue-100 bg-white/80 p-5 md:p-6 shadow-[0_10px_30px_rgba(30,77,140,0.08)] backdrop-blur">
      ...
      {approved.length === 0 ? (
        <div className="psychologist-activities-empty bg-white rounded-[24px] shadow-md p-12 text-center border border-blue-100">
